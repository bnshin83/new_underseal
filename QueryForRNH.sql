...
SELECT 
    ...
    stda_longlist.direction as "Travel Direction",
    ...
    null as "LTE",
    stda_calculations.e1_layer1_ksi as "E1",
    stda_calculations.e2_layer2_ksi as "E2",
    stda_calculations.e3_layer3_ksi as "E3",
    stda_calculations.e4_layer4_ksi as "E4",
...
SELECT 
    ...
    stda_longlist_info.request_no as "Request ID",
    stda_longlist.direction as "Direction", 
