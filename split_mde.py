...
This script is original written by Shreyam. 
It is a separate script that is not used elsewhere. 

Currently it is not sure the original intention of the code. 
The only thing that I find is an email sending from Shreyam to Dr. Shin.
"""
