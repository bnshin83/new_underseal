...
CREATE TABLE stda_CALCULATIONS(
    ...
    E1_Layer1_ksi 						DOUBLE PRECISION,
    E2_Layer2_ksi 						DOUBLE PRECISION,
    E3_Layer3_ksi 						DOUBLE PRECISION,
    E4_Layer4_ksi 						DOUBLE PRECISION,
	...
	UPDATED_USERID        	NUMBER(9)               NOT NULL,
	UPDATED_DATE          	DATE                    DEFAULT ON NULL SYSDATE       NOT NULL,
    E5_Layer5_ksi 						DOUBLE PRECISION
);
...
COMMENT ON COLUMN stda_CALCULATIONS.E1_Layer1_ksi IS 'Stores first column of elmod values (asphalt value)';
COMMENT ON COLUMN stda_CALCULATIONS.E2_Layer2_ksi IS 'Stores second column of elmod values (concrete value)';
COMMENT ON COLUMN stda_CALCULATIONS.E3_Layer3_ksi IS 'Stores third column of elmod values (middle layer value)';
COMMENT ON COLUMN stda_CALCULATIONS.E4_Layer4_ksi IS 'Stores fourth column of elmod values (subgrade value)';
...
COMMENT ON COLUMN stda_CALCULATIONS.E5_Layer5_ksi IS 'Stores fifth column of elmod values (newly added)';
...
COMMENT ON COLUMN stda_MODULI_ESTIMATED.E1_Layer1_ksi IS 'Stores elmod values of top layer';
COMMENT ON COLUMN stda_MODULI_ESTIMATED.E2_Layer2_ksi IS 'Stores elmod values of second from top layer';
COMMENT ON COLUMN stda_MODULI_ESTIMATED.E3_Layer3_ksi IS 'Stores elmod values of third from top layer';
COMMENT ON COLUMN stda_MODULI_ESTIMATED.E4_Layer4_ksi IS 'Stores elmod values of fourth to top layer';
COMMENT ON COLUMN stda_MODULI_ESTIMATED.E5_Layer5_ksi IS 'Stores elmod values of fifth from top layer';
