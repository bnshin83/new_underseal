...
def putcalc(con, data, id, pcc_mod, rxn_subg):
    ...
    Output:
        Return None
    <Concat the arrays and upload to the DB. What kind of array is being concatenated???>
    """
    ...
    # print(arr)
    ###### (Start) connection to DB and upload to DB ##########
    cursor = con.cursor()
    # print(arr)
    ...
    con.commit()
    cursor.close()       
    ###### (End) connection to DB and upload to DB ##########
